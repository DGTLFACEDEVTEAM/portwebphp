...
$(".activitiesModalDesktop1").on('hidden.bs.modal', function (e) {
    $(".activitiesModalDesktop1 iframe").attr("src", $(".activitiesModalDesktop1 iframe").attr("src"));
});
$(".activitiesModalDesktop2").on('hidden.bs.modal', function (e) {
    $(".activitiesModalDesktop2 iframe").attr("src", $(".activitiesModalDesktop2 iframe").attr("src"));
});
$(".activitiesModalDesktop3").on('hidden.bs.modal', function (e) {
    $(".activitiesModalDesktop3 iframe").attr("src", $(".activitiesModalDesktop3 iframe").attr("src"));
});