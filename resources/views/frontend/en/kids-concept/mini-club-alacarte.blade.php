...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('mini-club-alacarte') }}"
       aria-expanded="false">EN</a>
    <ul class="dropdown-menu dropdownmobile language">
        <li><a class="dropdown-item first-item" href="{{ route('tr-mini-club-alacarte') }}">TR</a></li>
...
<div class="mainHeader">
    <div class="row">
        ...
        <div class="col-lg-6 video">
            ...
            <a type="button" class="restPlayButtonDesktop" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <img class="playButton" src="{{ asset('assets/frontend/images/playButton.svg') }}" alt="playButton"/>
                <img class="videoCover" src="{{ asset('assets/frontend/images/miniclubalacarte/miniAlaCarteVideo.webp') }}" alt="youtubeVideo"/>
            </a>
            <!-- Modal -->
            <div class="modal fade restaurantModal" id="exampleModal" tabindex="-1" aria-labelledby="restaurantModalLabel"
                 aria-hidden="true">
