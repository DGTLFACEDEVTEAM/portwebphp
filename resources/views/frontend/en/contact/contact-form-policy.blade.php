...
@section('title', 'Contact Form Clarification Text - Port Nature Luxury Resort Hotel Spa')
@section('description', 'Clarification Text for Website Visitors Contacted via the Contact Form')

@section('header-lang')

<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('en-contact-form-policy') }}"
        aria-expanded="false">EN</a>
    <ul class="dropdown-menu dropdownmobile language">
        <li><a class="dropdown-item first-item" href="{{ route('ru-contact-form-policy') }}">RU</a></li>
        <li><a class="dropdown-item" href="{{ route('tr-contact-form-policy') }}">TR</a></li>
        <li><a class="dropdown-item" href="{{ route('de-contact-form-policy') }}">DE</a></li>
    </ul>
</li>
