...
@section('title', 'Bars and Cafes - Port Nature Luxury Resort Hotel')
@section('description', 'Bars and Cafes Port Nature Luxury Resort Hotel Spa. Five star beachfront hotel in Bogazkent Antalya. Book Antalya hotels at cheap prices.')
...
<div class="grid">
    ...
    <div class="item friendly">
        <div class="bars">
            <a class="roomlink" href="{{ route('pastahouse') }}">
                ...
                <article>
                    <p>Experience the magic of our pasta theater, where skilled chefs orchestrate a performance of culinary mastery</p>
                    <div class="moreButton">
                        <a href="{{ route('pastahouse') }}">More About</a>
                    </div>
                </article>
            </a>
        </div>
