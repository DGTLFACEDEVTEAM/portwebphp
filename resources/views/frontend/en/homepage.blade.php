                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <a class="ratinglink"
                            ...
                            target="_blank">
                            <img class="tripadvisorlogo-img lazyload" laoding="lazy"
                    ...
                    <div class="swiper-slide">
                        <a class="ratinglink"
                            ...
                            target="_blank">
                            <img class="googlelogo-img lazyload" laoding="lazy"
                    ...
                    <div class="swiper-slide">
                        <a class="ratinglink"
                            ...
                            target="_blank">
                            <img class="bookinglogo-img lazyload" laoding="lazy"
                    ...
                    <div class="swiper-slide">
                        <a class="ratinglink"
                            ...
                            target="_blank">
                            <img class="holidaychecklogo-img lazyload" laoding="lazy"
