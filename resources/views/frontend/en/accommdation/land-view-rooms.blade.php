...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('landview-rooms') }}"
    ...
    <ul class="dropdown-menu dropdownmobile language">
        ...
        <li><a class="dropdown-item first-item" href="{{ route('de-landview-rooms') }}">DE</a></li>
    </ul>
</li>
...
<img class="room-hero-image" src="{{ asset('assets/frontend/images/standardGardenView/rooms-standart-land-cover.webp') }}" alt="Garden view room hero image"/>
        ...
        <h1>STANDARD ROOM · LAnd VIEW</h1>
    </div>

    <div class="roomDetailText">
        <div class="container">
            <span>If you say "I have to see and breathe nature"<br> Land view rooms are for you.</span>
        </div>
    </div>
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 p-3">
                    <article>
                        ...
                        <p>Luxe fittings, intelligent design, and every conceivable comfort make these rooms hard to leave. Thoughtful touches are everywhere. In the bathroom, sleek marble surfaces offer space in abundance.</p>
                        <span>Enjoy with luxury services</span>
                    </article>
                </div>
            </div>
        </div>
   ...
   <div class="room-features-left" data-bs-toggle="modal" data-bs-target="#detailsImgModal">
         <div class="features-see-more " data-bs-toggle="modal" data-bs-target="#detailsImgModal">
           ...
           <p class="features-open-details">2 Adults + 2 Children / 3 Adults  ·  1 Single Bed  ·  1 Double Bed<br>34 m²  ·  Land View</p>
         </div>
           ...
           <div class="modal-dialog" id="features-modal-dialog">
             <div class="modal-content " id="features-modal-content">
               <div class="modal-body" id="features-modal-body">
                 ...
                 <p class="features-modal-title">Standard Room - Land View</p>
