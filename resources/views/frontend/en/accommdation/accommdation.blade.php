    ...
    <div class="roomsRows">
        ...
        <div class="roomDescWrapper" id="familyroom">
            <a class="roomlink" href="{{ route('family-rooms') }}">
                <h5>Family Room</h5>
                <p>Port Nature family rooms are the best choice for a family holiday. In family rooms, the child room located within is the best solution for families with children.</p>
                  <div class="roomSpecWrapper">
                        ...
                        <span class="extraSpec">
                            <img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp;&nbsp; Side Sea View
                        </span>
                    </div>
                ...
                <div class="swiper-wrapper lc-king">
                    <div class="swiper-slide">
                        <a href="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-1.webp') }}">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-1.webp') }}" alt="familyroom"/>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-2.webp') }}">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-2.webp') }}" alt="familyroom"/>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-3.webp') }}">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-3.webp') }}" alt="familyroom"/>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-4.webp') }}">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-4.webp') }}" alt="familyroom"/>
                        </a>
                    </div>
                    <div class="swiper-slide">
                        <a href="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-5.webp') }}">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/kingSuite/rooms-king-suite-5.webp') }}" alt="familyroom"/>
                        </a>
                    </div>
                </div>
                <div class="swiper-button-next">
            ...
            <a class="roomlink" href="{{ route('standard-rooms') }}">
              ...
              <span>
                  <img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/doublebed.svg') }}" alt="doublebed"/> x&nbsp; 1
                    ...
                    <span class="extraSpec deskExtraStandard"><img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp; Side Sea View / Sea View / Land View</span>
              </div>
                <div class="moreButton DeskMore">
                    <a href="{{ route('standard-rooms') }}">More About</a>
                </div>
