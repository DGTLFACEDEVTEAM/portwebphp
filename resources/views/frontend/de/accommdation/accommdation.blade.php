            ...
            <a class="roomlink" href="{{ route('de-family-rooms') }}">
                ...
                <div class="roomSpecWrapper">
                    ...
                    <span class="extraSpec">
                        <img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp;&nbsp; Mit seitlichem Meerblick
                    </span>
                </div>
        ...
        <div class="roomDescWrapper ">
            <a class="roomlink" href="{{ route('de-kingsuit-rooms') }}">
                ...
                <div class="roomSpecWrapper">
                    ...
                    <span class="extraSpec"><img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp;&nbsp; Mit Meerblick</span>
                </div>
                <div class="moreButton DeskMore">
        ...
        <div class="roomDescWrapper">
            <a class="roomlink" href="{{ route('de-standard-rooms') }}">
                ...
                <span>
                    ...
                    <span class="extraSpec deskExtraStandard"><img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp; Mit seitlichem Meer- / Meer- / Landblick</span>
                </div>
                <div class="moreButton DeskMore">
