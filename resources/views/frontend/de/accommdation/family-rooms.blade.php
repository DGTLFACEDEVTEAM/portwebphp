...
<img class="room-hero-image" src="{{ asset('assets/frontend/images/familyroom/rooms-family-room-slider.jpg') }}" alt="Family room hero image"/>
    ...
    <div class="roomDetailText">
        <div class="container">
            <span>Ein unvergesslicher Urlaub erwartet Sie in unseren Familienzimmern, in denen Ihr Kind seinen eigenen privaten Bereich findet, während Sie sich in Ihrem luxuriösen Hotelzimmer in Ihrem Traum-Familienurlaub entspannen.</span>
        </div>
    </div>
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 p-3">
                    <article>
                        ...
                        <p>Geräumige, luxuriöse Familienzimmer mit einer Vielzahl von Ausstattungsmerkmalen, eingerichtet nach den Standards des 21. Erleben Sie einen atemberaubenden Blick auf das Mittelmeer aus dem luxuriösen Hauptschlafzimmer.</p>
