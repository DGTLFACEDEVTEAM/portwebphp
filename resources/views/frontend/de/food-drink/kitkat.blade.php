...
@section('title', 'Kitkat Cafe - Port Nature Luxury Resort Hotel')
@section('description', 'Kitkat Cafe Port Nature Luxury Resort. Top 10 kinderfreundliche Hotels in Bogazkent Antalya. Buchen Sie jetzt im besten Familienhotel in Antalya.')
...
<div class="kitkatSlider">
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <a class="lightbox-kitkat" href="{{ asset('assets/frontend/images/kitkat/kitkatSlider-1.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/kitkat/kitkatSlider-1.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
        ...
        <div class="swiper-slide">
            <a class="lightbox-kitkat" href="{{ asset('assets/frontend/images/kitkat/kitkatSlider-5.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/kitkat/kitkatSlider-5.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>Knuspriger Waffelblätter und<br>weicher Schokoladenüberzug.</p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-kitkat" href="{{ asset('assets/frontend/images/kitkat/kitkatSlider-6.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/kitkat/kitkatSlider-6.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>Knuspriger Waffelblätter und<br>weicher Schokoladenüberzug.</p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-kitkat" href="{{ asset('assets/frontend/images/kitkat/kitkatSlider-7.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/kitkat/kitkatSlider-7.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>Knuspriger Waffelblätter und<br>weicher Schokoladenüberzug.</p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-kitkat" href="{{ asset('assets/frontend/images/kitkat/kitkatSlider-8.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/kitkat/kitkatSlider-8.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>Knuspriger Waffelblätter und<br>weicher Schokoladenüberzug.</p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-kitkat" href="{{ asset('assets/frontend/images/kitkat/kitkatSlider-9.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/kitkat/kitkatSlider-9.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>Knuspriger Waffelblätter und<br>weicher Schokoladenüberzug.</p>
