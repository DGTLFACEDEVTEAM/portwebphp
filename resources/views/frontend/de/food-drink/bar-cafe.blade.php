...
<div class="grid">
    ...
    <div class="item friendly">
     ...
     <div class="item friendly">
        <div class="bars">
            <a class="roomlink" href="{{ route('de-pastahouse') }}">
                ...
                <article>
                    <p>Erleben Sie die Magie unseres Pasta-Theaters, in dem erfahrene Köche eine kulinarische Meisterleistung inszenieren</p>
                    <div class="moreButton">
                        <a href="{{ route('de-pastahouse') }}">Mehr erfahren</a>
                    </div>
                </article>
            </a>
        </div>
