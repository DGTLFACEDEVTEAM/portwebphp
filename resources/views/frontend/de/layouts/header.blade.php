    ...
    <nav class="navbar navbar-expand-sm" id="navbar">
        <div class="">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <a class="navbar-icon" href="{{ route('de-homepage') }}"><img src="{{ asset('assets/frontend/images/logo-port-small.svg') }}" alt="logo"/> </a>
                <div class="menubar ">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item first-item" href="{{ route('de-mini-club') }}">Mini Club</a></li>
                            <li><a class="dropdown-item" href="{{ route('de-aquapark') }}">Aquapark</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="{{ route('de-special-offers') }}" aria-expanded="false">ANGEBOTE 2024</a>
                    </li>
                    <li class="nav-item dropdown">
                    ...
                    <li class="nav-item">
                        <a class="nav-link bookNowBtn" href="https://portnature.rezervasyonal.com/" target="_blank">Jetzt buchen</a>
                    </li>
                </div>
        ...
        <div class="mobileHeader">
            <div class="menuLeft">
                <span id="offcanvasOpenBtn" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
                    ...
                    <img style="width: 20px!important;height: 20px!important;" class="headerSvg" src="{{ asset('assets/frontend/images/hamburger.svg') }}" alt="Open Mobile Menu"/>
                </span>
            ...
            <div class="offcanvas-menu-section">
                <div class="accordion" id="accordionMobileMenu">
                    <div class="mobileDrop accordion-item">
                        <button class="mainLink accordion-button" data-bs-toggle="collapse" data-link="{{ route('de-accommodation') }}" data-bs-target="#accomdation" type="button"
                    ...
                    <div class="mobileDrop accordion-item">
                        <button class="mainLink accordion-button" data-bs-toggle="collapse" data-link="{{ route('de-kids-concepts') }}" data-bs-target="#kidsconcept" type="button"
                    ...
                    <div class="mobileDrop accordion-item">
                        <button class="mainLink accordion-button" data-bs-toggle="collapse" data-link="{{ route('de-food-drink') }}" data-bs-target="#foodDrink" type="button"
                    ...
                    <div class="mobileDrop accordion-item">
                        <button class="mainLink accordion-button" data-bs-toggle="collapse" data-link="{{ route('de-entertainment') }}" data-bs-target="#entertainment" type="button"
                    ...
                    <div class="mobileDrop accordion-item">
                        <button class="mainLink accordion-button" data-bs-toggle="collapse" data-link="{{ route('de-spa') }}" data-bs-target="#spa" type="button" aria-expanded="false"
                           aria-controls="spa">
                            SPA
                        <img class="arrow"  src="{{ asset('assets/frontend/images/arrowgray.svg') }}"></button>
                    ...
                    <div class="mobileDrop accordion-item">
                        <button class="mainLink accordion-button" data-bs-toggle="collapse" data-link="{{ route('de-meeting-congress') }}" data-bs-target="#meetingCongress" type="button"
