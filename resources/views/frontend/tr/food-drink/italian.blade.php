...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('tr-italian') }}"
...
<div class="restaurantInfo">
    ...
    <div class="restaurantText">
        <h1>İtalyan A'La Carte</h1>
        <p>Port Nature’ın İtalyan Restoranında orijinal İtalyan makarna çeşitleri ve üst düzey şeflerin elleriyle hazırladığı en kaliteli pizzalar bulunur. İtalyan atmosferi, İtalya'daymışsınız gibi hissettirir.</p>
    </div>
</div>
