...
<div class="alacarteGrid">
            <div class="restaurant">
                <a class="imglink" href="{{ route('tr-alldaydinning') }}">
                    ...
                    <div class="card-text-wrapper">
                        ...
                        <div class="moreButton">
                            <a href="{{ route('tr-alldaydinning') }}">More About</a>
                        </div>
                    </div>
            </div>
        <div class="restaurant">
            <a class="imglink" href="{{ route('tr-sushi-bar') }}">
                ...
                <div class="card-text-wrapper">
                    ...
                    <div class="moreButton">
                        <a href="{{ route('tr-sushi-bar') }}">More About</a>
                    </div>
                </div>
        </div>
        <div class="restaurant">
            <a class="imglink" href="{{ route('tr-italian') }}">
                ...
                <div class="card-text-wrapper">
                    ...
                    <div class="moreButton">
                        <a href="{{ route('tr-italian') }}">More About</a>
                    </div>
                </div>
        </div>
        <div class="restaurant">
            <a class="imglink" href="{{ route('tr-french') }}">
                ...
                <div class="card-text-wrapper">
                    ...
                    <div class="moreButton">
                        <a href="{{ route('tr-french') }}">More About</a>
                    </div>
                </div>
        </div>
        <div class="restaurant">
            <a class="imglink" href="{{ route('tr-seaside') }}">
                ...
                <div class="card-text-wrapper">
                    ...
                    <div class="moreButton">
                        <a href="{{ route('tr-seaside') }}">More About</a>
                    </div>
                </div>
        </div>
        <div class="restaurant">
            <a class="imglink" href="{{ route('tr-mini-club-alacarte') }}">
                ...
                <div class="card-text-wrapper">
                    ...
                    <div class="moreButton">
                        <a href="{{ route('tr-mini-club-alacarte') }}">More About</a>
                    </div>
                </div>
        </div>
        <div class="restaurant">
            <a class="imglink" href="{{ route('tr-fareast') }}">
                ...
                <div class="card-text-wrapper">
                    ...
                    <div class="moreButton">
                        <a href="{{ route('tr-fareast') }}">More About</a>
                    </div>
                </div>
