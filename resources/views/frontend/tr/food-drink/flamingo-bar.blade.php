...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('tr-flamingo-bar') }}"
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-8">
            ...
            <div class="barDetailHeroText"><!-- CLASS CHANGED ***************************** -->
                ...
                <article>
                    <p>Sıcak ve nemli günlerde dinlenmek istiyorsanız Flamingo havuz başı bar, bol ithal içki ve soğuk-sıcak içecekleri ile her daim serin bir seçim.</p>
                </article>
            </div>
        </div>
    </div>
