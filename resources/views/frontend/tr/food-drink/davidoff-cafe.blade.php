...
@section('title', 'Davidoff Kafe - Port Nature Luxury Resort Hotel')
@section('description', 'Davidoff Kafe Port Nature Hotel. Belek otel ultra her şey dahil tatil paketi indirimleri. Şimdi Antalya Belek te 5 yıldızlı otel rezervasyonu yapın.')
...
<div class="davidoffSlider">
    <div class="swiper-wrapper">
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-1.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-1.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-2.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-2.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-3.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-3.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-4.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-4.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-5.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-5.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-6.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-6.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-7.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-7.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-8.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-8.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
        ...
        <div class="swiper-slide">
            <a class="lightbox-davidoff" href="{{ asset('assets/frontend/images/davidoff/davidoff-9.webp') }}">
                <figure>
                    <img src="{{ asset('assets/frontend/images/davidoff/davidoff-9.webp') }}" alt="coffee"/>
                </figure>
            </a>
            <article>
                <p>"Güzel bir şeyden alınan zevk,<br> mutlu bir hayatın özüdür." </p>
