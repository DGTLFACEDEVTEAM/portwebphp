...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('tr-fareast') }}"
...
<div class="restaurantInfo">
    ...
    <div class="restaurantText">
        ...
        <p>Uzak Doğu'nun cezbedici lezzetlerini, damak zevkinize hitap edecek geleneksel ve çağdaş yemeklerden oluşan zengin bir menü sunan restoranımızda deneyimleyin. Aromatik körilerden etli kızartmalara, Port Nature Uzak Doğu restoranı.</p>
    </div>
</div>
