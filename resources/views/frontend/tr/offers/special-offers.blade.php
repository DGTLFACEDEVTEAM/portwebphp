...
@section('content')
                ...
                <div class="modal-body">
                    ...
                    <div class="dropdown adult-dropdown">
                        <img class="dropdown-icons people"
                            src="{{ asset('assets/frontend/images/offers/mobile-booking/adult.webp') }}"> Yetişkin(ler)
    ...
    <div class="opportunity-wrapper first-booking-opportunities">
        ...
        <div class="swiper opportunity-swiper">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a href="{{ route('tr-antalya-hotels') }}" target="blank" class="opportunity-slide">
                        ...
                        <div class="opportunity-text">
                            ...
                            <a class="transfer-btn" target="blank" href="{{ route('tr-antalya-hotels') }}">Daha
                                Fazla</a>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
                    <a target="blank" href="{{ route('tr-turkey-hotels') }}" class="opportunity-slide">
                        <div class="op-img-wrapper">
                            <img src="{{ asset('assets/frontend/images/offers/general/turkey.webp') }}" />
                        </div>
                        <div class="opportunity-text">
                            <p class="opportunity-title">Türkiye Otelleri</p>
                            <a class="transfer-btn" target="blank" href="{{ route('tr-turkey-hotels') }}">Daha Fazla</a>
                        </div>
                    </a>
                </div>
                <div class="swiper-slide">
    ...
    <div class="offers-first-split">
        ...
        <a class="split-img" href="https://www.portnature.com.tr/tr">
            <img
                src="{{ asset('assets/frontend/images/offers/seo/tr/antalya/antalya-otelleri-port-nature premium-hotel-resort.webp') }}" />
        </a>
    </div>
