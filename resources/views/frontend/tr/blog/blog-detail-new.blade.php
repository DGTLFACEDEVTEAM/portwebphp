        ...
        <div class="container">
            ...
            @php
                function replaceElement($description)
                {
                    ...
                    $replacementBooking = view('frontend.tr.layouts.booking')->render(); // Replace this with the desired content
                    $description = str_replace($bookingElement, $replacementBooking, $description);
                    // contact replacement
                    $replacementContact = view('frontend.tr.layouts.contact')->render();
