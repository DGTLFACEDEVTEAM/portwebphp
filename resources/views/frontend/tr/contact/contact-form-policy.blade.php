...
@section('title', 'İletişim Formu Aydınlatma Metni - Port Nature')
@section('description', 'İletişim Formu Aracılığıyla İletişime Geçen Web Sitesi Ziyaretçisi için Aydınlatma Metni')

@section('header-lang')

<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('tr-contact-form-policy') }}"
