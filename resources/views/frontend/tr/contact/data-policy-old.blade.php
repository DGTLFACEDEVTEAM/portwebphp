...
<div class="subpage-content">
   <div class="container">
       <div class="row">
           <div class="col-12">
               <div class="kvkk-title ">Kişisel Verilere İlişkin Aydınlatma Metni</div>
               <div class="kvkk-subtitle text-center">Veri Sorumlusu: Aras İnşaat Ticaret Turizm A.Ş</div>
...
İlgili Kişi: [https://portnature.com.tr/] alan adlı web sitemizi ziyaret ettiğiniz için çerezler ve farklı tanımlayıcılarla bazı kişisel verilerini işlediğimiz siz, Kanun tarafından ilgili kişi olarak tanımlanmaktasınız.
...
<br>
                ...
                <div class="text-center">
                   <a target="_blank"
                      href="{{ asset('/uploads/data_policy/1_1598628189_veri-sahibi-basvuru-formu.pdf') }}"
