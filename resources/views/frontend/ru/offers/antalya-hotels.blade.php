...
@section('content')
    ...
    <div class="hero-mobile-intro-wrapper">
        ...
        <p class="hero-mobile-text">
            Анталия включает в себя лучшие 5-звездочные отели «все включено» с гибкими предложениями. Если вы ищете
            роскошные туристические предложения, не ищите никаких других отелей Анлаи, которые вас ждут. Вы можете легко
            забронировать номер в колл-центре или онлайн-бронировании отелей Анталии. Кроме того, услуги колл-центра отелей
            Анталии имеют лучшие цены и возможности в последнюю минуту. Веб-сайт отелей Анталии и служба колл-центра
            предлагают лучшие предложения. Не упустите шанс и позвоните прямо сейчас. В отеле Анталии есть номера для всех.
            Если вы ищете жилье с горящими предложениями, отель Анталии ждет вас. </p>
    ...
    <div class="showcase-section-wrapper showcase-section-ru">
        ...
        <div class="booking-section-wrapper booking-section-ru">
            <p class="booking-ru-additional-text">При оплате кредитными картами операций бронирования возможны различия в
                8-15%, обусловленные курсами обмена валют вашего банка с центральным банком</p>
            ...
            <div class="booking">
                <div class="dropdown room-selection-dropdown">
                    ...
                    <ul class="dropdown-menu room-selection-dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li>
                            <div class="dropdown-item room-dropdown-link" href="#" data-value="Семейный Номер ">
                                Семейный Номер </div>
                        </li>
                        <li>
                            <div class="dropdown-item room-dropdown-link" href="#" data-value="Номера Стандарт">
                                Номера Стандарт</div>
                        </li>
                        <li>
                            <div class="dropdown-item room-dropdown-link" href="#" data-value="Номер Suite">Номер
                                Suite</div>
                        </li>
                    </ul>
                </div>
        ...
        <div class="offers-rooms-swiper swiper">
            <p class="offers-room-swiper-title-mobile">Размещение</p>
            <div class="swiper-wrapper">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="dropdown adult-dropdown">
                        <img class="dropdown-icons people"
                            src="{{ asset('assets/frontend/images/offers/mobile-booking/adult.webp') }}"> Взрослые <button
                ...
                <div class="modal-footer">
                    <button type="button" class="booking-modal-close modal-close-family"
                        data-bs-dismiss="modal">Сделанный</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="reservation-form  ">
            ...
            <div class="dateInputDiv" name="daterange" id="calendarRange">
                ...
                <p class=" p-16 reservation-titles">
                    <span id="check-in-span" class="checkInSpan">Дата заезда</span> — <span id="check-out-span"
                        class="checkOutSpan">
                        Дата выезда</span>
                </p>
            ...
            <div class="flight-wrapper">
                <p class="flight-addendum">
                    ...
                    ответственность за любой ущерб или убытки, возникшие из-за содержимого других веб-сайтов. Все ссылки на
                    другие веб-сайты предоставлены на нашем веб-сайте для удобства пользователей нашего веб-сайта. Это
                    соглашение не подразумевает, что Port Nature или ее филиалы каким-либо образом связаны с этими другими
                    веб-сайтами или их владельцами.
                ...
                <div class="flight-swiper-div">
                    <div class="swiper flight-swiper">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <a href="https://ru.skyscanner.com/?currency=RUB&locale=ru-RU&market=RU&traveller_context=6ad51ea2-8b52-4ebb-a20f-4a40f8737f62"
                            ...
                            <div class="swiper-slide">
                                <a href="https://www.turkishairlines.com/ru-int/flights/booking/index.html"
            ...
            <div class="transfer-wrapper">
                ...
                <div class="transfer-texts">
                    ...
                    <a class="transfer-btn" target="blank" href="https://portnature.rezervasyonal.com/ExtraService"
                        target="_blank">Заказать трансфер</a>
                </div>
            </div>
            ...
            <div class="flight-wrapper-mobile">
                <div class="flight-mobile-div">
                        ...
                        <div class="flight-items-wrapper">
                            <div class="flight-item-wrapper">
                                <a href="https://www.flypgs.com/sehirler/antalya-ucak-bileti" target="_blank">
                                    <img class="pegasus-logo"
                                        src="{{ asset('assets/frontend/images/offers/logo-1.webp') }}" />
                                </a>
                            </div>
                            <div class="flight-item-wrapper">
                                <a href="https://www.skyscanner.com.tr/?currency=TRY&locale=tr-TR&market=TR&traveller_context=80b9152e-fef3-4182-b891-7b26102e22dd"
                                    target="_blank">
                                    <img class="scanner-logo"
                                        src="{{ asset('assets/frontend/images/offers/logo-2.webp') }}" />
                                </a>
                            </div>
                            <div class="flight-item-wrapper">
                                <a href="https://www.corendonairlines.com/tr" target="_blank">
                                    <img class="corendon-logo"
                                        src="{{ asset('assets/frontend/images/offers/logo-3.webp') }}" />
                                </a>
                            </div>
                            <div class="flight-item-wrapper">
                                <a href="https://www.aviasales.ru/?params=IST1&currency=usd" target="_blank">
                                    <img class="avia-logo"
                                        src="{{ asset('assets/frontend/images/offers/logo-4.webp') }}" />
                                </a>
                            </div>
                            <div class="flight-item-wrapper">
                                <a href="https://www.turkishairlines.com/tr-int/ucak-bileti/rezervasyon/" target="_blank">
                                    <img class="turkish-logo"
                                        src="{{ asset('assets/frontend/images/offers/logo-5.webp') }}" />
                                </a>
                            </div>
                        </div>
                        <p class="flight-mobile-addendum">Ссылки, которые ссылаются из нашего веб-сайта на другие
                            веб-сайты, не возлагают на владельца сайта ответственности за содержимое веб-сайтов, на которые
                            даны ссылки, и владелец сайта не может нести ответственность за любой ущерб или убытки,
                            возникшие из-за содержимого других веб-сайтов. Все ссылки на другие веб-сайты предоставлены на
                            нашем веб-сайте для удобства пользователей нашего веб-сайта. Это соглашение не подразумевает,
                            что Port Nature Hotels
                            или ее филиалы каким-либо образом связаны с этими другими веб-сайтами или их владельцами.


                        </p>
                    </div>
                    <a class="flight-collapse-button collapsed" data-bs-toggle="collapse"
                        data-bs-target="#flightCollapse" aria-expanded="false" aria-controls="flightCollapse">
                    ...
                    <a class="transfer-mobile-btn" href="https://portnature.rezervasyonal.com/" target="_blank">
                        Забронировать трансфер</a>
                </div>
            </div>
            ...
            <div class="offers-first-split">
                ...
                <div class="split-text">
                    ...
                    <p><b>Отели в Анталии</b> являются самыми из доступных курортов на Средиземном море. Новые отели ультра
                        все включено в
                        Анталии сделают ваш отдых идеальным в регионе Анталия. Отели Анталия цены очень выгодные и
                        популярные отели
                        Анталии станут лучшим выбором для всей семьи. Кроме того, Анталия Белек отели включают в себя
                        5-звездночные
                        отели, которые располагаются на берегу моря. Вы можете найти лучший отель Анталия, когда будете
                        отдыхать
                        вместе с семьей. Если вы задаетесь вопросом, где отдохнуть в Анталии, несомненно выбирайте <a
                            href="https://www.portnature.com.tr/spa-centr">спа отели
                            Анталия</a>.</p>
                </div>
                <a class="split-img" href="https://www.portnature.com.tr/ru">
                    <img
                        src="{{ asset('assets/frontend/images/offers/seo/ru/antalya/oteli-v-antalii-port-nature-premium-resort-hotel.webp') }}" />
                </a>
            </div>
                        ...
                        <div class="swiper-slide">
                            <a href="{{ route('ru-concert') }}" class="opportunity-slide">
                                ...
                                <div class="opportunity-text">
                                    ...
                                    <p>Насладитесь концертами с участием лучших исполнителей со всего мира, не выходя из
                                        роскошного отеля Port Nature Luxury Resort. </p>
                                </div>
                            </a>
                        </div>
                        <div class="swiper-slide">
                            <a href="https://www.tripadvisor.ru/Attractions-g297962-Activities-Antalya_Turkish_Mediterranean_Coast.html"
                                ...
                                <div class="opportunity-text">
                                    <p class="opportunity-title">Посетите лучшие места в Анталии
                                        ...
                                        🥰 💤 🏖 </p>
                                    <p>Анталия является обязательным местом для посещения с уникальной природой для тех, кто
                                        хочет погрузиться в богатую историю и культуру этого прекрасного города. </p>
                                </div>
                            </a>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            ...
                                            We had a family vacation 2vzr and children (4 and 6 years old) in May 2022 and
                                            were
                                            delighted 😍 Despite the fact that the concerts were canceled, the animation was
                                            at the
                                            highest level.
                                        </p>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            An unbiased review of an objective tourist is a good Turkish hotel, strong,
                                            good.As a
                                            result, I will say that I can recommend the hotel, even despite the end of the
                                            season
                                            everything was great, at least for us. Mood creates emotions. What you tune in
                                            to, you
                                            will get)
                                        </p>
                                    </div>
                                ...
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            ...
                                            I have been to many hotels in Turkey, but this one will always remain in my
                                            heart! There
                                ...
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            ...
                                            I liked everything very much, the weather let us down for a couple of days, but
                                            there
                                            are no complaints about the hotel. Top notch service, excellent food. In a word,
                                            I love
                                            it!!!
                                        </p>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            Vacation with wife
                                            We were received very warmly and joyfully. A pleasant surprise was a one-time
                                            free visit
                                            to the spa with a choice of any procedure you like. This is really wow! Thank
                                            you!
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            ...
                                            This is our second year with the whole family. And for the second year we are
                                            leaving
                                            with good impressions. Children's animation is on top. Will definitely come back
                                            again!
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            Rest is great
                                            I really liked the hotel, delicious cocktails, I like the food in the
                                            restaurant. Every
                                            evening there is a mini disco for younger children, younger children run with
                                            joy every
                                            evening.
                                        </p>
                                    </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            Lovely vacation
                                            Oh, we fell in love with this hotel with all our heart, it was a wonderful
                                            vacation
                                            where everyone liked it.
                                            Kids club you are the best!!! Thanks to all the staff of the hotel. We will come
                                            again!
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rating-item">
                                    ...
                                    <div class="rating-lower">
                                        <p class="rating-text">
                                            Liked the hotel very much. Vacationing with my son. There are many activities
                                            for
                                            children, every day there are activities on the street. Animator Nastya spends
                                            boccia,
            ...
            <div class="splits-mother-wrapper">
                    ...
                    <div class="split-wrapper first-split">
                        <div class="split-1">
                            ...
                            <img class="split-svg-mobile"
                                src="{{ asset('assets/frontend/images/offers/svg/mobile/plane-2.svg') }}">

                        </div>
                        <div class="split-2">
                            <h2 class="split-text-1">Самые лучшие отели в Анталии</h2>
                            <p>
                                <b>Самые лучшие отели в Анталии</b> - известный курорт на Лазурном побережье Турции,
                                предлагающий широкий
                                выбор услуг. Если вы планируете отдых с семьей, то стоит обратить внимание на семейные
                                лучшие отели
                                Анталии 5 звезд, которые предлагают множество <a
                                    href="https://www.portnature.com.tr/razvlecheniya">развлечений для детей и
                                    взрослых</a>. В то же время, для
                                тех, кто ищет новые отели в Анталии, здесь также имеются отличные варианты, где вы сможете
                                наслаждаться широким спектром услуг и современными номерами. Независимо от того, какой отель
                                вы
                ...
                <div class="split-wrapper second-split">
                    <div class="split-1">
                        ...
                        <p> Если вы ищете <a href="https://www.portnature.com.tr/akvapark"><b>отели Анталии 5 звезд все
                                    включено с аквапарком</b></a>, то в городе можно найти множество
                            вариантов, соответствующих вашим запросам. Такие отели предлагают своим гостям не только водные
                            развлечения, но и широкий выбор услуг, включая <a
                                href="https://www.portnature.com.tr/restorani-alacarte">рестораны A'la Carte</a> и
                            спа-центры. Если же вы хотите
                            насладиться видом на море прямо из номера, то следует обратить внимание на отели Анталии 5 звезд
                            все
                            включено первая линия, которые также предлагают услуги все включено. Независимо от того, какой
                            тип
                    ...
                    <a class="split-2" href="https://www.portnature.com.tr/alacarte-restoran-all-day-dining">
                        <img class="offers-split-photo"
                            src="{{ asset('assets/frontend/images/offers/seo/ru/antalya/oteli-v-antalii-vse-vklucheno-restoran-ala-carte-all-day-dining.webp') }}">
                ...
                <div class="grey-wrapper">
                    <div class="split-wrapper third-split split-with-svg">
                        <div class="split-1">
                            <div class="split-svg colorful-image-wrapper"></div>
                            <img class="split-svg-mobile"
                                src="{{ asset('assets/frontend/images/offers/svg/mobile/belek.svg') }}">

                        </div>
                        <div class="split-2">
                            <h4 class="split-text-3">Семейные отели в Анталии 5 звезд</h4>
                            <p>
                                <b>Анталия отдых с детьми</b> - идеальная причина провести его в семейных отелях 5 звезд
                                всей семьей.
                                Анталия отели с детьми 5 звезд предлагают <a
                                    href="https://www.portnature.com.tr/razvlecheniya">развлечения</a> для детей всех
                                возрастов. Отели в Анталии
                                ...
                                популярностью среди семейных туристов, поскольку позволяют наслаждаться прекрасным видом на
                                море и
                                удобным доступом к пляжу. Анталия семейные отели готовы предложить вам все, что нужно для
                                незабываемого отдыха с детьми.
                            </p>
                            <h3 class="third-second-h4 split-text-3">Лучшие отели Анталии</h3>
                            <p>
                                Анталия - популярный курорт, привлекающий множество туристов со всего мира. Лучшие отели в
                                Анталии
                                предлагают услуги на любой вкус и кошелек. Если вы ищете комфортабельное размещение по
                                лучшей цене,
                                то в Анталии есть отели для любого бюджета. Также здесь представлены <b>Анталия семейные
                                    отели</b>, которые
                                идеально подходят для отдыха с детьми. Можно легко узнать цены в отели Анталия и <a
                                    href="https://portnature.rezervasyonal.com/" target="_blank">забронировать отель
                                    Анталья (Antalya booking hotel)</a> через специализированные сайты. Лучшие отели в
                                Анталии можно
                                забронировать заранее, чтобы не переживать о доступности размещения во время вашего
                                прибытия. </p>
                        </div>
                    </div>
                </div>
                <div class="split-wrapper fourth-split split-with-picture">
                    <a class="split-1" href="https://www.portnature.com.tr/alacarte-restoran-mini-club">
                        <img class="offers-split-photo"
                            src="{{ asset('assets/frontend/images/offers/seo/ru/antalya/lucshiye-oteli-antalii-5-zvezd-vse-vklucheno-mini-klub-dla-detey.webp') }}">
                    ...
                    <div class="split-2">
                        ...
                        <p>
                            ...
                            <b>Отели Анталии на первой линии</b> пользуются большой популярностью среди туристов. <b>Отель
                                Анталья забронировать</b>
                            можно через <a href="https://portnature.rezervasyonal.com/" target="_blank">сайт онлайн
                                резервации</a> или <a href="tel:+902427310707">позвонить в колл-центр Port Nature Premium
                                Hotel</a>. Отели ультра все
                            включено Анталия обеспечат незабываемый отдых для всех возрастных груп. Семейные отели в Анталии
                            подойдут
                            для отдыха с детьми и создадут уютную атмосферу. Выбирая лучший отель Анталья, обращайте
                            внимание на удобства
                ...
                <div class="grey-wrapper">
                    <div class="split-wrapper fifth-split">
                        <div class="split-1">
                            ...
                            <p>
                                <b>Лучшие отели Анталии на первой линии</b> – это популярное турецкое курортное место, куда
                                каждый год
                                приезжают туристы со всего мира. Некоторые из самых лучших отелей Анталии на первой линии
                                предлагают
                                пятизвездочный сервис все включено. Отели Анталии 5 звезд все включено первая линия обычно
                                имеют
                                собственный частный пляж, открытый и <a
                                    href="https://www.portnature.com.tr/kritiy-basseyn">крытый бассейны</a>, а также
                                аквапарк. Отель Анталия на первой
                                линии – это прекрасный выбор для тех, кто ищет уединение и комфорт, наслаждаясь красивым
                                видом на
                                море.
                            </p>
                ...
                <div class="split-wrapper sixth-split split-with-picture">
                    <div class="split-1">
                        <a href="https://www.portnature.com.tr/nomer-king-suite">
                            <img class="offers-split-photo"
                                src="{{ asset('assets/frontend/images/offers/seo/ru/antalya/otdih-v-antalii-tseni-nomer-king-suite.webp') }}">
                            <img class="split-svg-mobile"
                    ...
                    <div class="split-2">
                        ...
                        <p>
                            В Анталии можно найти множество отелей разного уровня и комфорта. Но если вы хотите выбрать
                            самые
                            лучшие, то вот топ-10 лучших отелей Анталии: Анталия отели 5 звезд все включено, отели в Анталии
                            на
                            первой линии, отели ультра все включено Анталия и лучшие семейные отели в Анталии. Среди них
                            можно
                            выделить <b>самый лучший отель Анталии</b>, где вас ждут наивысший уровень сервиса и уютные <a
                                href="https://www.portnature.com.tr/nomera">номера</a>. Если вы
                            путешествуете с детьми, то лучше выбрать семейные отели в Анталии 5 звезд, где найдется
                            множество
                            развлечений для маленьких гостей. <a href="tel:+902427310707">Забронировать отель Анталия</a>
                            можно заранее, чтобы быть уверенным в
                            выборе. </p>
                ...
                <div class="grey-wrapper">
                    <div class="split-wrapper seventh-split split-with-svg">
                        ...
                        <div class="split-1">
                            ...
                            <p>
                                Отдых в Анталии - это прекрасная возможность насладиться теплым морем и красивыми видами. Но
                                сколько
                                стоит отдых в Анталии? <a href="https://portnature.rezervasyonal.com/"
                                    target="_blank"><b>Цены на отдых в Анталии</b></a> зависят от многих факторов: отеля,
                                сезона, количества
                                дней, услуг и т.д. Чтобы получить лучшую цену, можно <a
                                    href="https://portnature.rezervasyonal.com/" target="_blank"><b>забронировать отель
                                        Анталии</b>
                                </a> заранее. Компании
                                предлагают различные скидки и специальные предложения, особенно для семей с детьми. Можно
                                получить
                                <a href="tel:+902427310707">скидки через колл-центр отеля</a> или <a
                                    href="https://portnature.rezervasyonal.com/" target="_blank">бронирование через
                                    сайт</a>. Отели в Анталии имеют разные цены, и вы
                                можете найти отель, который подходит вашему бюджету. Анталия ол инклюзив цена может быть
                                выгоднее,
                                чем покупка путевки все включено цена. Так что, если вы ищете <b>отели Анталия цены</b>,
                                ищите настоящие
                            ...
                            <p>
                                Анталия - это прекрасное место для отдыха, но <b>в каком районе Анталии лучше отдыхать</b>?
                                Если вы ищете
                                тихий и спокойный отдых, то лучше обратить внимание на районы <a
                                    href="https://ru.wikipedia.org/wiki/%D0%91%D0%B5%D0%BB%D0%B5%D0%BA">Белек</a> и <a
                                    href="https://tonkosti.ru/%D0%91%D0%BE%D0%B3%D0%B0%D0%B7%D0%BA%D0%B5%D0%BD%D1%82">Богазкент</a>.
                                Здесь вы найдете
                                красивые пляжи, роскошные отели в Анталии и уединение с природой. Для тех, кто предпочитает
                                активный
                                отдых, можно рассмотреть район Кемер с живой ночной жизнью, множеством кафе, ресторанов и
                                магазинов.
                                Если вы не уверены, как выбрать отель в Анталии, то можно позвонить в колл-центр отелей для
                                подробной информации или забронировать отель через сайт. Также не забывайте о том, что чем
                                раньше вы
                                бронируете отели в Анталии, тем больше шансов получить хорошую скидку и выбрать именно тот
                                номер,
                                который вам нужен. Так что выбирайте лучшие районы Анталии для отдыха и наслаждайтесь своим
                                отдыхом
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <a href="{{ route('ru-activity') }}" class="stage-inner-wrapper">
                                    <img class="stage-img"
                                        src="{{ asset('assets/frontend/images/offers/activities.webp') }}">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('ru-concert') }}" class="stage-inner-wrapper">
                                    <img class="stage-img"
                                        src="{{ asset('assets/frontend/images/offers/concert.webp') }}">
                                    <div class="stage-text">
                            ...
                            <div class="swiper-slide">
                                <a href="{{ route('ru-aquapark') }}" class="stage-inner-wrapper">
                                    <img class="stage-img"
                                        src="{{ asset('assets/frontend/images/offers/aquapark.webp') }}">
                                    <div class="stage-text">
                ...
                <div class="three-img-wrapper">
                    <div class="three-img-div">
                        ...
                        <div class="three-img-text">
                            ...
                            <p>
                                <b>Анталия отели с детьми</b> - это замечательная возможность провести время всей семьей.
                                Лучшие отели
                                Анталии для детей предлагают множество развлечений, такие как анимационные программы и <a
                                    href="https://www.portnature.com.tr/detskiy-koncept">детский клуб</a>
                                <a href="https://www.portnature.com.tr/alacarte-restoran-mini-club">отель Анталья</a>. Если
                                вы планируете поездку с детьми, выбирайте отели, где есть все для комфортного
                                пребывания. Лучшие семейные отели Анталии предоставляют скидки и предлагают вкусную и
                                здоровую еду
                                для детей. Бронируйте отели через сайт или колл-центр отеля, чтобы получить скидки и лучшие
                                условия.
                                Популярные районы Анталии для отдыха с детьми - это Белек, Кемер и Сиде. Анталия отели все
                                включено
                    ...
                    <div class="three-img-div">
                        ...
                        <div class="three-img-text">
                            ...
                            <p>
                                Среди лучших курортов Анталии, можно отметить Белек, Кемер и Алания. <b>Курорты Антальи</b>
                                отличаются
                                высоким уровнем сервиса, большим выбором развлечений и уютной атмосферой для отдыха. Многие
                                <b>курорты
                                    Анталии</b> предлагают <b>всё включено</b>, что является удобным и экономически выгодным
                                вариантом для
                                туристов. Гости могут выбрать курорт Анталии, соответствующий их предпочтениям и бюджету,
                                так как <a href="https://portnature.rezervasyonal.com/" target="_blank">цены на курорты
                                    Анталии</a> различаются в зависимости от сезона и категории отеля. </p>
                        </div>
                    </div>
                    <div class="three-img-div">
                        ...
                        <div class="three-img-text">
                            ...
                            <p>
                                <b>Анталия путевки все включено цены</b> более выгодные, чем в других курортах, что даст вам
                                возможность
                                провести отдых на высшем уровне. Для более выгодного отдыха в Анталии стоит приобрести
                                путевку в
                                Анталию заранее. При этом можно выбрать путевку по выгодной цене и с услугами "все
                                включено".
                                Существует множество вариантов путевок в Анталию, включая путевки с различными
                                дополнительными
                                услугами и разным уровнем комфорта. Не забывайте, что Анталия раннее бронирование отеля
                                предлагает
                    ...
                    <div class="double-text-wrapper double-reverse">
                        ...
                        <div class="double-text">
                            ...
                            <p>
                                ...
                                Отель в Анталии - это идеальное место для комфортного и роскошного отдыха. <b>Популярные
                                    отели Анталии</b>
                                расположены в различных районах, таких как Белек, Лара и Кемер. Молодежные отели в Анталии
                                предлагают различные услуги, такие как клубы, <a
                                    href="http://portnature.com.tr/alacarte-restoran-all-day-dining">All Day Dining</a>, <a
                                    href="http://portnature.com.tr/alacarte-restoran-sushi-bar">Sushi Bar</a>, <a
                                    href="https://www.portnature.com.tr/alacarte-restoran-seaside">Seaside</a>, <a
                                    href="https://portnature.com.tr/alacarte-restoran-italyannskiy">Итальянский</a> и
                                <a href="https://www.portnature.com.tr/alacarte-restoran-francuzskiy">Французский
                                    рестораны</a> мировой кухни. Кроме того <a href="https://portnature.com.tr/ru">отель в
                                    Анталии Port Nature Luxury Resort Hotel</a>
                                предлагает импортные алкоголи в барах <a
                                    href="https://www.portnature.com.tr/script-chivas-launge">Script Chivas Lounge</a>, <a
                                    href="https://www.portnature.com.tr/born9-hennessy-launge">Born 9 Hennessy Lounge</a>,
                                <a href="https://www.portnature.com.tr/pub-irish">Irish Pub</a>,
                                <a href="https://www.portnature.com.tr/flamingobar">Flamingo Bar</a> и <a
                                    href="https://www.portnature.com.tr/lobbybar">Lobby Bar</a>. Дополнительно к этому, вы
                                всегда сможете взбодриться с чашечкой кофе и
                                вкусными пирожными в <a href="https://www.portnature.com.tr/kafe-davidoff">Davidoff
                                    Cafe</a>, <a href="https://www.portnature.com.tr/kafe-kit-kat">KitKat</a> и <a
                                    href="https://www.portnature.com.tr/kafe-nespresso">Nespresso</a>.
                            </p>
                        </div>
                        ...
                        <div class="double-text">
                            ...
                            <p>
                                ...
                                варианты! <a href="https://www.portnature.com.tr/akvapark">Отели с подогреваемым бассейном
                                    Анталия</a> пользуются большим спросом, особенно весной и
                                осенью. Анталия Белек отели предлагают проживание на побережье с прекрасными видами на море.
                                Не
                                забудьте воспользоваться Анталия раннее бронирование, чтобы сэкономить на проживании. Мы
                                собрали для
                                вас хорошие отели Анталии на сайте <b>Букинг Анталия</b>. Не упустите свой шанс
                                забронировать отели в
                ...
                <div class="split-wrapper eighth-split">
                    <div class="split-1">
                        ...
                        <img class="three-img-mobile img-rotate"
                            src="{{ asset('assets/frontend/images/offers/svg/ticket.svg') }}">
                        <img class="three-img-mobile img-rotate"
                            src="{{ asset('assets/frontend/images/offers/svg/glasses.svg') }}">
                    </div>
                    <div class="split-2">
                        <h4 class="split-text-12">Отель Анталия номер</h4>
                        <p>
                            Отель Анталия – идеальное место для отдыха всей семьей! <a
                                href="https://www.portnature.com.tr/akvapark"><b>Анталия отели с аквапарком</b></a> имеют
                            комфортабельные
                            <a href="https://www.portnature.com.tr/nomera">номера</a>, как <a
                                href="https://www.portnature.com.tr/nomer-king-suite">King Suite</a>, <a
                                href="https://www.portnature.com.tr/semeyniy-nomer">Семейные номера</a> и <a
                                href="https://www.portnature.com.tr/nomera-standart">номера Стандарт</a>. Анталия раннее
                            бронирование отеля позволит
                            Вам сэкономить на проживании. Наши <b>хорошие отели Анталии</b> с чистыми и семейными номерами
                            подходят для
                            отдыха всей семьей. Вы можете забронировать номера с видом на море, чтобы наслаждаться красивым
                            пейзажем
                            прямо из своего окна.
                        </p>
                    </div>
                </div>
                ...
                <div class="double-text-wrapper double-text-single">
                    <div class="double-text">
                        ...
                        <p>
                            ...
                            Анталия известный город, где возможно насладиться концертами российских звезд! Хотите совместить
                            отдых с
                            развлечениями? Выбирайте <b>отели все включено в Анталии</b> – они предлагают множество
                            развлечений и удобств
                            для гостей. Чтобы не пропустить свой любимый концерт, не забудьте <a
                                href="https://www.portnature.com.tr/concerti">купить билеты на концерт в Анталии</a>
                            заранее или забронировать их онлайн. Мы подобрали лучшие развлечения в отеле Анталии, где вы
                            сможете
