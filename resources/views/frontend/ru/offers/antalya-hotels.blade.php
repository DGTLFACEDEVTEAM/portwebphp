...
<div class="flight-wrapper">
    ...
    <div class="flight-swiper-div">
        <div class="swiper flight-swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
<a href="https://www.flypgs.com/ru" target="_blank"><img class="pegasus-logo" src="{{ asset('assets/frontend/images/offers/logo-1.webp') }}" /></a>                </div>
                <div class="swiper-slide">
<a href="https://ru.skyscanner.com/?currency=RUB&locale=ru-RU&market=RU&traveller_context=6ad51ea2-8b52-4ebb-a20f-4a40f8737f62" target="_blank"><img class="scanner-logo" src="{{ asset('assets/frontend/images/offers/logo-2.webp') }}" /></a>                </div>
                <div class="swiper-slide">
...
<a href="https://www.aviasales.ru/?params=IST1&currency=usd" target="_blank"><img class="avia-logo" src="{{ asset('assets/frontend/images/offers/logo-4.webp') }}" /></a>                </div>
                <div class="swiper-slide">
<a href="https://www.turkishairlines.com/ru-int/flights/booking/index.html" target="_blank"><img class="turkish-logo" src="{{ asset('assets/frontend/images/offers/logo-5.webp') }}" /></a>                </div>
            </div>
        </div>
    </div>
        ...
        <div class="split-svg colorful-image-wrapper"></div>
            ...
            <div class="split-2">
                ...
                <p>
                    ...
                    идеально подходят для отдыха с детьми. Можно легко узнать цены в отели Анталия и <a href="https://portnature.rezervasyonal.com/" target="_blank">забронировать отель
    ...
    <div class="split-wrapper fourth-split split-with-picture">
        ...
        <div class="split-2">
            ...
            <p>
                ...
                можно через <a href="https://portnature.rezervasyonal.com/" target="_blank">сайт онлайн резервации</a> или <a href="tel:+902427310707">позвонить в колл-центр Port Nature Premium Hotel</a>. Отели ультра все 
        ...
        <div class="split-wrapper seventh-split split-with-svg">
            ...
            <div class="split-1">
                ...
                <p>
                    ...
                    стоит отдых в Анталии? <a href="https://portnature.rezervasyonal.com/" target="_blank"><b>Цены на отдых в Анталии</b></a> зависят от многих факторов: отеля, сезона, количества
                    дней, услуг и т.д. Чтобы получить лучшую цену, можно <a href="https://portnature.rezervasyonal.com/" target="_blank"><b>забронировать отель Анталии</b>
                    </a> заранее. Компании
                    предлагают различные скидки и специальные предложения, особенно для семей с детьми. Можно получить
                    <a href="tel:+902427310707">скидки через колл-центр отеля</a> или <a href="https://portnature.rezervasyonal.com/" target="_blank">бронирование через сайт</a>. Отели в Анталии имеют разные цены, и вы
        ...
        <div class="split-svg three-img-2 colorful-image-wrapper"></div>
            <div class="three-img-text">
                ...
                <p>
                    ...
                    так как <a href="https://portnature.rezervasyonal.com/" target="_blank">цены на курорты Анталии</a> различаются в зависимости от сезона и категории отеля. </p>
            </div>
        </div>
        <div class="three-img-div">
