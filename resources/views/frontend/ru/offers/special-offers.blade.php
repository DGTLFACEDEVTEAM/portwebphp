...
<!-- Hero Mobile Section Start -->
 <div class="gallery-wrapper">
   <p class="hero-mobile-subtitle">
      Премиум-а-ля-карт «все включено»
    </p>
...
<div class="showcase-section-wrapper showcase-section-ru">
 ...
 <div class="accommodations-features-grid collapse accommodations-features-russian" id="collapseExample">
  ...
  <span class="btn-collapsed">Больше о</span>
    <span class="btn-open"> Меньше о</span>
...
<div class="opportunity-wrapper first-booking-opportunities">
    ...
    <div class="swiper opportunity-swiper">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a target="blank" href="{{ route('ru-turkey-hotels') }}"
                    ...
                    <div class="opportunity-text">
                        <p class="opportunity-title">Отели Турции</p>
                            <a class="transfer-btn" target="blank" href="{{ route('ru-turkey-hotels') }}">Подробнее</a>
                    </div>
                </a>
            </div>
            <div class="swiper-slide">
