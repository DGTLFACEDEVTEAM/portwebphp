        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="offers-slide-inner">
                    ...
                    <p class="offers-addendum-right">Забронируй отдых через колл-центр и получи 4 жетона в подарок</p>
                </div> --}}
            ...
            <div class="swiper-slide">
                <div class="offers-slide-inner offers-4">
                    ...
                    <div class="transfer-addendum-wrapper"><p class="offers-4-addendum">
                        ...
                        VIP-трансфера</p>
                        <p class="offers-addendum-left"> Забронируй отдых через колл-центр и получи 4 жетона в подарок</p>
                    </div> --}}
