          ...
          <div class="roomDescWrapper" id="familyroom">
              <a class="roomlink" href="{{ route('ru-family-rooms') }}">
                  ...
                  <div class="roomSpecWrapper">
                      ...
                      <span class="extraSpec"><img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp;&nbsp; Угловой вид на море</span>
                  </div>
          ...
          <div class="roomDescWrapper ">
              <a class="roomlink" href="{{ route('ru-kingsuit-rooms') }}">
                  ...
                  <div class="roomSpecWrapper">
                      ...
                      <span class="extraSpec"><img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp;&nbsp; Вид на море</span>
                  </div>
                  <div class="moreButton DeskMore">
                      <a href="{{ route('ru-kingsuit-rooms') }}">Подробнее</a>
                  </div>
          ...
          <div class="roomDescWrapper">
              <a class="roomlink" href="{{ route('ru-standard-rooms') }}">
                  ...
                  <span>
                      ...
                      <span class="extraSpec deskExtraStandard"><img class="accommdationSvg lazyload" data-src="{{ asset('assets/frontend/images/accommdation/view.svg') }}"/>&nbsp;&nbsp; Боковой вид / Море / Окрестности</span>
                  </div>
                  <div class="moreButton DeskMore">
                      <a href="{{ route('ru-standard-rooms') }}">Подробнее</a>
                  </div>
