...
@section('title', 'Hомер Стандарт вид на море - Port Nature')
@section('description', 'Забронировать номер Стандарт вид на море в Port Nature. Пятизвездочный семейный отель ультра все включено в Белек, Анталия. ')
    ...
    <div class="container">
      ...
      <div class="room-features-left" data-bs-toggle="modal" data-bs-target="#detailsImgModal">
         <div class="features-see-more " data-bs-toggle="modal" data-bs-target="#detailsImgModal">
           ...
           <p class="features-open-details">2 Взрослых + 2 Ребенок / 3 Взрослых  ·  1 односп. кровати  ·  1 двусп. кровать<br>34 m²  ·  Вид на море</p>
         </div>
           ...
           <div class="modal-dialog" id="features-modal-dialog">
             <div class="modal-content " id="features-modal-content">
               <div class="modal-body" id="features-modal-body">
                 ...
                 <p class="features-modal-title">Номер Стандарт - Вид на море</p>
