...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('ru-lobby-bar') }}"
    ...
    <ul class="dropdown-menu dropdownmobile language">
        ...
        <li><a class="dropdown-item" href="{{ route('de-lobby-bar') }}">DE</a></li>
    </ul>
</li>
    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-8">
            ...
            <div class="barDetailHeroText">
                ...
                <article>
                    <p>Алкоголь премиум-класса, а также холодные и горячие напитки. Круглосуточный открытый бар с роскошным дизайном и современной атмосферой.</p>
                </article>
            </div>
        </div>
    </div>
