...
<div class="grid">
    ...
    <div class="item friendly">
        <div class="bars">
            <a class="roomlink" href="{{ route('ru-pastahouse') }}">
                ...
                <article>
                    <p>Окунитесь в волшебство нашей пасты, приготовленной опытными поварами</p>
                    <div class="moreButton">
                        <a href="{{ route('ru-pastahouse') }}">Подробнее</a>
                    </div>
                </article>
            </a>
        </div>
