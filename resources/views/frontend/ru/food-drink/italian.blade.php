...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="{{ route('ru-italian') }}"
...
<div class="restaurantInfo">
    ...
    <div class="restaurantText">
        <h1>Итальянский A’La Carte</h1>
        <p>Оригинальные итальянские сорта пасты и вкуснейшая пицца, приготовленная руками лучших шеф-поваров. Ресторан итальянской атмосферы даст вам почуствовать, что вы находитесь в Италии.</p>
    </div>
</div>
