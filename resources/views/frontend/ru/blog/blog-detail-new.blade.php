...
@section('content')
    ...
    <section class="blog">
        ...
        <div class="container">
            ...
            @php
                function replaceElement($description)
                {
                    ...
                    $replacementBooking = view('frontend.ru.layouts.booking')->render(); // Replace this with the desired content
        ...
        <div class="recomBlogGrid">
            <h6>
                <a href="{{ route('ru-blog') }}">Прочитайте наши другие статьи</a>
            </h6>
            <div class="blogGrid">
                @foreach ($otherPosts->slice(0, 8) as $post_item)
                    <div class="miniBlog">
                        <a href="{{ url('/blog-stranica' . '/' . $post_item->slug) }}">
                            <figure>
