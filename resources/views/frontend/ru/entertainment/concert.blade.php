...
<div class="concert-calendar">
    <div class="concert-calendar-img-wrapper">
        <img class="concert-calendar-img calendar-img-desktop" src="{{ asset('assets/frontend/images/concerts/2024-KONSERLER-1920x1080-RU.webp') }}">
        <img class="concert-calendar-img calendar-img-tablet" src="{{ asset('assets/frontend/images/concerts/2024-KONSERLER-1080x1920-RU.webp') }}">
        <img class="concert-calendar-img calendar-img-mobile" src="{{ asset('assets/frontend/images/concerts/2024-KONSERLER-1080x1920-RU.webp') }}">
    </div>
