...
<div id="heroSwiperWrapper">
    <div class="swiper-container heroTopSwiper">
        <div class="heroText">
            ...
            <img loading="lazy" class="heroLogo" src="{{ asset('assets/frontend/images/home/heroLogoBig.webp') }}"
                alt="logo" />
        </div>
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <picture>
                    <source media="(max-width: 420px)" sizes="(max-width: 420px) 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-2-414.webp') }}" />
                    <source media="(min-width: 421px) and (max-width: 1024px)" sizes="(min-width: 421px) 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-2-820.webp') }}" />
                    <source media="(min-width: 1025px) and (max-width: 1920px)"
                        sizes="(min-width: 1025px) 33.3vw, 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-2-1920.webp') }}" />
                    <source media="(min-width: 1921px)" sizes="33.3vw, 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-2-2560.webp') }}" />
                    <img loading="lazy" src="{{ asset('assets/frontend/images/home/banner/carousel-2-2560.webp') }}"
                        class="d-block homeHeroSwiperImg" alt="Pool Image" />
                </picture>
            </div>
            ...
            <div class="swiper-slide">
                <picture>
                    <source media="(max-width: 420px)" sizes="(max-width: 420px) 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-3-414.webp') }}" />
                    <source media="(min-width: 421px) and (max-width: 1024px)" sizes="(min-width: 421px) 50vw, 100vw"
                    ...
                    <source media="(min-width: 1921px)" sizes="33.3vw, 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-3-2560.webp') }}" />
                    <img loading="lazy" src="{{ asset('assets/frontend/images/home/banner/carousel-3-2560.webp') }}"
                        class="d-block homeHeroSwiperImg" alt="Beach Image" />
                </picture>
            </div>
            ...
            <div class="swiper-slide">
                <picture>
                    <source media="(max-width: 420px)" sizes="(max-width: 420px) 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-4-414.webp') }}" />
                    <source media="(min-width: 421px)" sizes="(min-width: 421px) 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-4-820.webp') }}" />
                    <source media="(min-width: 1025px) and (max-width: 1920px)"
                        sizes="(min-width: 1025px) 33.3vw, 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-4-1920.webp') }}" />
                    <source media="(min-width: 1921px)" sizes="33.3vw, 50vw, 100vw"
                        srcset="{{ asset('assets/frontend/images/home/banner/carousel-4-2560.webp') }}" />
                    <img loading="lazy" src="{{ asset('assets/frontend/images/home/banner/carousel-4-2560.webp') }}"
                        class="d-block homeHeroSwiperImg" alt="Hotel image at night" />
                </picture>
            </div>
