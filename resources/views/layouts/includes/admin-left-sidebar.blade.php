                    ...
                    <div class="user-profile text-center mt-3">
                        <div class="">
                            @if (Auth::user()->role_as == '1')
                                <img src="{{ asset('assets/admin/images/users/avatar-6.jpg') }}" alt=""
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li>
                                        <a href="{{ url('/admin/post-list') }}"><i class="ri-file-list-line"></i>Makale
                                            Listele</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/admin/post-create-new') }}"><i
                                                class="ri-markup-line"></i>Makale Ekle (Yeni)</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/admin/post-create') }}"><i class="ri-file-add-line"></i>Makale
                                            Ekle</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="{{ url('/admin/offer-list') }}" class="waves-effect">
                            ...
                            <li>
                                <a href="https://www.youtube.com/watch?v=APk4mLodk88" target="_blank"
                                    class="waves-effect">
