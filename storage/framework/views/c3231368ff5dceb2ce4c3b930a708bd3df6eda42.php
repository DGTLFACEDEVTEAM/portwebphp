...
<div class="cookieConstentContainer">
    <div class="cookieConstentWrapper">
        <div class="cookieConstentInformation">
            <div class="cookieConstentTitle"><?php echo $translation[$lang]['cookieConstentTitle']; ?></div>
            <div class="cookieConstentDesc">
                <?php echo $translation[$lang]['cookieConstentDesc']; ?>

            </div>
        </div>
        <div class="cookieConstentActions">
            <button class="cookieConstentAccept  cookieA"><?php echo $translation[$lang]['cookieConstentAccept']; ?></button>
            <button class="cookieConstentManage" data-bs-toggle="modal"
                data-bs-target="#customizeCookie"><?php echo $translation[$lang]['cookieConstentManage']; ?></button>
        ...
        <div class="modal-content cookieModal">
            ...
            <div class="modal-body">
                <div class="cookieHeader">
                    <h5 class="modal-title w-100 text-center" id="exampleModalLabel"><?php echo $translation[$lang]['cookieHeader']; ?></h5>
                    <button type="button" class="btn-close me-2" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class=cookieBodyDesktop>
                    <div class="cookieLeft">
                        <?php $__currentLoopData = $translation[$lang]['cookieDesktop']['cookieBtn']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button"
                                class="cookieBtn <?php echo e($key == 0 ? 'active' : ''); ?>"><?php echo e($item); ?></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <div class="cookieRight">
                        <?php $__currentLoopData = $translation[$lang]['cookieDesktop']['cookieRightT']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cookieRightT <?php echo e($item['css']); ?>  <?php echo e($key !== 0 ? 'hide' : ''); ?>">
                                <div>
                                    <h2><?php echo e($item['title']); ?></h2>
                                    <p><?php echo e($item['desc']); ?></p>
                                </div>
                                <?php if($item['switch'] !== 'None'): ?>
                                    <div class="form-check form-switch switchContainer disabledC">
                                        ...
                                        <input class="form-check-input cookieSwitch" role="switch" type="checkbox"
                                            ...
                                            <?php echo e($item['switch'] == 'Disable' ? 'disabled' : ''); ?>>
                                    </div>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <div class="cookieRightB">
                            ...
                            <?php $__currentLoopData = $translation[$lang]['cookieDesktop']['cookieRightB']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button"
                                    class="actionBtns cookieA <?php echo e($item['btnCss']); ?>"><?php echo e($item['btnText']); ?></button>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                </div>
                <div class="cookieBodyMobile p-3">
                    ...
                    <div>
                        <?php $__currentLoopData = $translation[$lang]['cookieMobile']['cookieAccs']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="cookieMobileOptions">
                                <div class="cookieDetailAccorHeader">
                                    <div class="privacy-title"><?php echo e($item['title']); ?></div>
                                    <svg class='mr-1 ' width='20' height='20'>
                                        <use
                                            xlink:href='<?php echo e(asset('assets/admin/fonts/remixicon.symbol.svg')); ?>#ri-arrow-down-s-line'>
                                        </use>
                                    </svg>
                                </div>
                    ...
                    <div class="cookieMobileActions">
                        ...
                        <?php $__currentLoopData = $translation[$lang]['cookieMobile']['cookieActionBtns']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button type="button"
                                class="actionBtns cookieA <?php echo e($item['btnCss']); ?>"><?php echo e($item['btnText']); ?></button>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /Users/jack/Documents/GitHub/portwebphp/resources/views/components/cookie.blade.php ENDPATH**/ ?>