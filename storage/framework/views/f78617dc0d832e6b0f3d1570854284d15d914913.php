...
<head>
    ...
    <link rel="preload" href="<?php echo e(asset('assets/frontend/images/logo-port-small.svg')); ?>" as="image"
        type="image/svg+xml" />
    <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/libs/css/swiper-bundle-11.min.css')); ?>" />
...
<body>
    ...
    <?php echo $__env->make('frontend.en.layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->yieldContent('content'); ?>

    <?php echo $__env->make('frontend.en.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- cookieConsent -->
    ...
    <script src="<?php echo e(asset('assets/frontend/libs/js/swiper-bundle-11.min.js')); ?>"></script>
            ...
            (function() {
                ...
                function insertLivechatJS() {
                    ...
                    e.type = "text/javascript", e.async = "true", e.src =
                        "<?php echo e(asset('assets/frontend/libs/js/livechat.js')); ?>";
                    var t = document.createElement("link");
                    t.rel = "stylesheet", t.href = (process && process.env && process.env.DOMAIN ||
                        "https://portnature.com.tr") + "/assets/frontend/css/chatbox.css";
                    var n = document.getElementsByTagName("script")[0];
...
<?php /**PATH /Users/jack/Documents/GitHub/portwebphp/resources/views/frontend/en/layouts/master.blade.php ENDPATH**/ ?>