...
<div class="inclusiveArea">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <span><?php echo $translation[$lang]['span']; ?></span>
            </div>
        </div>
        <div class="inclusiveText">
            <p><?php echo $translation[$lang]['inclusiveText1']; ?></p>
            <p><?php echo $translation[$lang]['inclusiveText2']; ?></p>
        </div>
    </div>
            ...
            <div class="col-lg-4">
                <div class="row">
                    <div class="col-md-12 starNumber"> 5 <img loading="lazy" alt="icon"
                            src="<?php echo e(asset('assets/frontend/images/home/inclusiveStar.svg')); ?>" alt="star" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="swiper inclusiveSlider">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <img srcset="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-1-640.webp')); ?> 640w,<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-1-834.webp')); ?> 834w "
                                ...
                                src="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-1.webp')); ?>"
                                alt="Portnature Hotel Pics" loading="lazy" />
                            <div class="swiper-lazy-preloader"></div>
                        </div>

                        <div class="swiper-slide">
                            <img srcset="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-3-640.webp')); ?> 640w,<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-3-834.webp')); ?> 834w "
                                sizes="((min-width: 1px) and (max-width:576px)) 640w,((min-width: 577px) and (max-width:834px)) 834w,((min-width: 835px) and (max-width:1919px)) 640w, (min-width:1920px) 640w"
                                src="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-3.webp')); ?>"
                                alt="Portnature Hotel Pics" loading="lazy" />
                            <div class="swiper-lazy-preloader"></div>
                        </div>
                        <div class="swiper-slide">
                            <img srcset="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-2-640.webp')); ?> 640w,<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-2-834.webp')); ?> 834w "
                                sizes="((min-width: 1px) and (max-width:576px)) 640w,((min-width: 577px) and (max-width:834px)) 834w,((min-width: 835px) and (max-width:1919px)) 640w, (min-width:1920px) 640w"
                                src="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-2.webp')); ?>"
                                alt="Portnature Hotel Pics" loading="lazy" />
                            <div class="swiper-lazy-preloader"></div>
                        </div>
                        <div class="swiper-slide">
                            <img srcset="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-4-640.webp')); ?> 640w,<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-4-834.webp')); ?> 834w "
                                sizes="((min-width: 1px) and (max-width:576px)) 640w,((min-width: 577px) and (max-width:834px)) 834w,((min-width: 835px) and (max-width:1919px)) 640w, (min-width:1920px) 640w"
                                src="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-4.webp')); ?>"
                                alt="Portnature Hotel Pics" loading="lazy" />
                            <div class="swiper-lazy-preloader"></div>
                        </div>
                        <div class="swiper-slide">
                            <img srcset="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-5-640.webp')); ?> 640w,<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-5-834.webp')); ?> 834w "
                                sizes="((min-width: 1px) and (max-width:576px)) 640w,((min-width: 577px) and (max-width:834px)) 834w,((min-width: 835px) and (max-width:1919px)) 640w, (min-width:1920px) 640w"
                                src="<?php echo e(asset('assets/frontend/images/home/inclusiveSlider-5.webp')); ?>"
                                alt="Portnature Hotel Pics" loading="lazy" />
                            <div class="swiper-lazy-preloader"></div>
                        </div>
                    </div>
...
<?php /**PATH /Users/jack/Documents/GitHub/portwebphp/resources/views/components/inclusiveSwiper.blade.php ENDPATH**/ ?>